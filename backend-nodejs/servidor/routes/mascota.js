...
const storage = multer.diskStorage({
  destination: function (req, file, cb) {
    // Usar ruta absoluta para que siempre guarde en backend-nodejs/uploads/mascotas
    const uploadPath = path.resolve(__dirname, "../../uploads/mascotas");
...
router.put("/:id/foto", upload.single("foto"), async (req, res) => {
  try {
    ...
    // Devuelve el nombre del archivo y la URL para que el frontend lo use
