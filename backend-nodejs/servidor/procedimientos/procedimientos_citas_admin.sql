...
-- =================================================================
-- ==      PROCEDIMIENTOS ALMACENADOS PARA GESTIÓN DE CITAS (ADMIN) ==
-- =================================================================

-- OBTENER TODAS LAS CITAS (Para la tabla principal del admin)
DROP PROCEDURE IF EXISTS Admin_MostrarTodasCitas$$
...
-- OBTENER DATOS PARA FORMULARIOS (Selects del modal)
DROP PROCEDURE IF EXISTS Admin_ObtenerDatosFormularioCitas$$
...
DROP PROCEDURE IF EXISTS Admin_InsertarCita$$
...
BEGIN
    ...
    VALUES (
        p_fech_cit, p_hora, p_cod_ser, p_id_vet, p_cod_mas, p_id_pro, p_estado, p_notas
    );
    SELECT LAST_INSERT_ID() as cod_cit;
END$$

-- ACTUALIZAR UNA CITA EXISTENTE
DROP PROCEDURE IF EXISTS Admin_ActualizarCita$$
...
-- ELIMINAR UNA CITA
DROP PROCEDURE IF EXISTS Admin_EliminarCita$$
...
DROP PROCEDURE IF EXISTS Admin_ObtenerEstadisticasCitas$$
...
DROP PROCEDURE IF EXISTS Admin_MostrarAuditoriaCita$$
