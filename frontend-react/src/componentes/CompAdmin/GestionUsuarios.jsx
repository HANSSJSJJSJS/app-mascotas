...
const GestionUsuarios = () => {
    ...
    // NUEVOS ESTADOS PARA LA AUDITORÍA
    ...
    const validateForm = () => {
      ...
      // Validación documento (7-11 dígitos)
      ...
      // Validación barrio (3-30 caracteres)
      ...
      // Validación ciudad (3-30 caracteres)
      ...
      // Validación dirección con nomenclatura
