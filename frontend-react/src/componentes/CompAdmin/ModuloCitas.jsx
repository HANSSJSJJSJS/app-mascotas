...
const ModuloCitas = ({ isSidebarOpen = true }) => {
  const citasData = [
    {
      id: 1,
  ...
  const handleAcceptCita = (id) => {
    setCitas(citas.map((cita) => (cita.id === id ? { ...cita, estado: "confirmada" } : cita)))
  }
          ...
          <div className="modal-content">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-buttons">
                <button type="button" className="btn btn-cancel" onClick={handleFormClose}>
                  Cancelar
                </button>
      ...
      <div className="content-card">
        ...
        <div className="controls-row">
          <div className="show-entries">
            <span>Mostrar</span>
            <select id="show-records" value={recordsPerPage} onChange={handleRecordsPerPageChange}>
          ...
          <div className="search-box">
            <span>Buscar:</span>
            <input type="text" id="search" value={search} onChange={handleSearchChange} placeholder="Buscar..." />
          </div>
        </div>
        ...
        {filteredCitas.length > 0 && (
          <div className="pagination">
            <div className="page-info">
              Mostrando del {filteredCitas.length ? indexOfFirstRecord + 1 : 0} al{" "}
              {Math.min(indexOfLastRecord, filteredCitas.length)} de total {filteredCitas.length} registros
            </div>
