...
export default function Home() {
  ...
  return (
    <main className="main-content">
      ...
      <section className="services">
        <div className="container">
          ...
          <div className="row g-4">
            ...
            <div className="col-md-4">
              <div className="service-card">
                <Phone className="service-icon" size={48} />
      ...
      {/* Testimonials Section - Modificado sin carrusel */}
            ...
            <div className="col-md-4">
              <div className="testimonial-card">
                <div className="testimonial-content">
                  <MessageSquare className="testimonial-quote-icon" />
                  <p>
                    "El servicio de peluquería canina es increíble. Mi perro Rocky siempre vuelve feliz y con un corte impecable.
                    El personal es muy cariñoso con los animales y los precios son justos. 100% recomendado."
                  </p>
                  <div className="testimonial-author">
                    <div className="testimonial-avatar">
                      <span>AP</span>
