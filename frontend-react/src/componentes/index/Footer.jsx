    ...
    <footer className="footer-prin">
      <div className="footer-container">
        <div>
          ...
          <p className="footer-slogan">Cuidando a tus mascotas como si fueran nuestras</p>
        ...
        <div>
          <h3>Servicios</h3>
          <p>
            <Link to="/Servicios">Consulta veterinaria</Link>
          </p>
          <p>
            <Link to="/Servicios">Peluquería canina</Link>
          </p>
          <p>
            <Link to="/Adopcion">Adopción de mascotas</Link>
          </p>
          <p>Lunes a Sábado: 8am – 5pm</p>
          <p>Urgencias: 24/7</p>
        <div className="footer-image">
          <img src={Catimg} alt="Mascotas felices" className="footer-img" />
        </div>
        </div>
      </div>
    </footer>
