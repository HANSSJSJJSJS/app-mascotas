...
export default function Home() {
  useEffect(() => {
    ...
    if (testimonialCarouselElement) {
      const testimonialCarousel = new Carousel(testimonialCarouselElement)
  ...
  return (
    <main className="main-content">
          ...
          <div className="row g-4">
            <div className="col-md-4">
              <div className="service-card">
                <Heart className="service-icon" size={90} />
            ...
            <div className="col-md-4">
              <div className="service-card">
                <Calendar className="service-icon" size={50} />
            ...
            <div className="col-md-4">
              <div className="service-card">
                <Phone className="service-icono" size={30} />
      ...
      <section className="contact-info py-5">
        <div className="container">
          <div className="section-title-container text-center">
            <h3 className="section">Información de Contacto</h3>
          </div>
          <div className="row g-4">
            <div className="col-md-4">
          ...
          <div className="text-center mt-5">
            <Link to="/Contacto" className="button type1">
              <span className="btn-txt">Contáctanos</span>
            </Link>
          </div>
        </div>
      </section>
